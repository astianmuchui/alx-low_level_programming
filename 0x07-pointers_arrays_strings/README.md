...
/**
 * simple_print\_buffer - prints buffer in hexa
...
- Edit the source list sudo nano /etc/apt/sources.list to add the following line: deb [here](http://security.ubuntu.com/ubuntu) xenial-security main Then sudo apt update and sudo apt install libssl1.0.0
